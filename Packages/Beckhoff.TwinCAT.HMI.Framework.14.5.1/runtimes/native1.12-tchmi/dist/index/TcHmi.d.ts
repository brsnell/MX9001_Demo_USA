...
import * as _TcUiClient from '../API/TcUiClient.js';
declare global {
    namespace TcHmi {
        /**
         * Functions for interaction with the TcUiClient.
         * @preserve (Part of the public API)
         */
        namespace TcUiClient {
            let isAvailable: typeof _TcUiClient.isAvailable;
            let kiosk: typeof _TcUiClient.kiosk;
            let screenshot: typeof _TcUiClient.screenshot;
            type KioskParameters = _TcUiClient.KioskParameters;
            type ScreenshotParameters = _TcUiClient.ScreenshotParameters;
        }
    }
}
