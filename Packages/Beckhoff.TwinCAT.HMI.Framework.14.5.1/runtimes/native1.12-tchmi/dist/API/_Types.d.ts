...
export interface JsonSchema extends nativeJsonSchema {
    ...
    function?: boolean;
    /**
     * Used by server to mark a multi-dimensional array so clients render it as a matrix. The value stores the number of dimensions.
     */
    displayAsMatrix?: number;
}
/**
...
export interface ControlDescription {
    ...
    /** FQN of inheritance parent. Can be a legacy name like 'tchmi-control'. */
    base: string;
    /**
     * List of Controls used in this control. For example ["tchmi-button", "tchmi-region"]
     * Replaced by Package entry in manifest.json#modules in 1.12 and later.
     * @deprecated Used in 1.8 and 1.10 only.
     */
    uses: string[];
    category: string;
    displayPriority?: number;
