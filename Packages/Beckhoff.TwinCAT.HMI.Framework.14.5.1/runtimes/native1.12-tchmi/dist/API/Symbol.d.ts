...
export declare namespace Symbol {
    ...
    /**
     * A type assertion for differentiating a IServerWriteResultObject from a IWriteResultObject
     * @param data IWriteResultObject
     */
    function isIServerWriteResultObject<W = any, R = W>(data: IWriteResultObject<R> | IServerWriteResultObject<W, R>): data is IServerWriteResultObject<W, R>;
