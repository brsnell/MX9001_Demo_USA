 ...
 */
declare class TcHmiControl extends baseTcHmiControl {
    #private;
    ...
    protected __passThroughEvents: {
        ...
        destroyers: Map<number, DestroyFunction> | null;
    }[];
    protected __syntheticEvents: {
         ...
         */
        action: (eventRegistrationData: EventProvider.IEventRegResultObject, baseEvent: EventProvider.Event, ...args: any[]) => void;
        /** Maps the event IDs of registered TcHmiEvents to their destroy functions. */
        destroyers: Map<number, DestroyFunction> | null;
    }[];
    /**
     ...
     */
    protected readonly __attrs: Controls.ControlAttributeList;
    /**
     * Control Id
     */
    ...
    /**
     *  GridLayout of the Control inside a TcHmiGridContainer control.
     */
    protected __gridItemLayout: GridItemLayout | null | undefined;
    /**
     *  FlexLayout of the Control inside a TcHmiFlexContainer control.
     */
    protected __flexItemLayout: FlexItemLayout | null | undefined;
    /**
     ...
     */
    protected __parent: baseTcHmiControl | null;
    /**
     * Child controls of the control.
     */
    protected readonly __children: baseTcHmiControl[];
    /**
     ...
     */
    protected __accessConfig: AccessControl[];
    /**
     * A list of virtual control right mappings.
     */
    protected __virtualControlRightMappings: VirtualControlRightMapping[];
    protected __classNames: string[] | undefined;
    /**
     * Map of Symbol.ObjectResolver used in attributes.
     * This map holds heterogeneous resolvers (each attribute uses its own value type),
     * so the generic parameter is "any". ObjectResolver is invariant in its type
     * parameter and "watchCallback" is checked contravariantly under strictFunctionTypes,
     * which makes a single concrete type (e.g. "object | null") incompatible with the
     * differently typed resolvers that are actually stored here.
     */
    protected __objectResolvers: Map<string, {
        resolver: ObjectResolver<any>;
        watchCallback: (data: ObjectResolver.IWatchResultObject<any>) => void;
        watchDestroyer: DestroyFunction | null;
    }>;
    protected __localization: ControlLocalization;
    /**
     ...
     */
    protected __borderColor: Color | null | undefined;
    /**
     * Internal reference to the attribute "data-tchmi-border-width".
     */
    protected __borderWidth: BorderWidth | null | undefined;
    /**
     * Internal reference to the attribute "data-tchmi-border-radius".
     */
    protected __borderRadius: BorderRadius | null | undefined;
    /**
     * Internal reference to the attribute "data-tchmi-border-style".
     */
    protected __borderStyle: BorderStyle | null | undefined;
    /**
     * Internal reference to the attribute "data-tchmi-box-shadow".
     */
    protected __boxShadow: BoxShadow[] | null | undefined;
    /**
     *  Trigger
     */
    protected __trigger: Trigger[] | null | undefined;
    /**
     *  Trigger which are active even when detached (only own onInitialized and onDestroyed)
     */
    protected __triggerNonAttachList: Trigger[];
    /**
     *  Trigger which are active only when attached
     */
    protected __triggerAttachList: Trigger[];
    /**
     ...
     */
    protected __background: Partial<Background>;
    /**
    ...
    __attach(): void;
    /**
     * Ensures that every registered object resolver has a live watch.
     *
     * An attached control must always watch all of its object resolvers ("attached => watched"). A watch
     * can be torn down out-of-band while the control is (or becomes again) attached without a fresh
     * __attach() call: a resolver watch callback that observes a transiently detached state may call
     * __suspendObjectResolver() (see e.g. __onResolverForClassNamesWatchCallback), and the attach/detach
     * edge that would normally re-watch in __attach() can be coalesced away by the asynchronous DOM
     * mutation processing in the ControlManager (e.g. fast page/region switching). Re-asserting the watch
     * here keeps the invariant independent of that edge, so a suspended resolver does not stay dead.
     *
     * The loop is idempotent: resolvers that already have a live watch are left untouched.
     * @preserve (Part of the public API)
     */
    __ensureObjectResolversWatched(): void;
    /**
     ...
     * @returns
     */
    protected getAttributeDescription(propertyName: string): ControlAttributeDescription | null;
    /**
     ...
     * @param event
     */
    protected __onFunctionResultChanged(_event: EventProvider.Event, data: string[], dataEx?: {
        propertyName: string;
     ...
     * @param event
     */
    protected __onPropertyChanged(_event: EventProvider.Event, data: {
        propertyName: string;
        noLegacyForwarding?: boolean;
        dirtyPaths?: string[];
    }): void;
     ...
     * @preserve (Part of the public API)
     */
    getAttrs(): Controls.ControlAttributeList;
    /**
     ...
     */
    protected __onResolverForClassNamesWatchCallback(data: ObjectResolver.IWatchResultObject<string[]>): void;
    /**
     * Process classes.
     */
     ...
     */
    protected __onResolverForAccessConfigWatchCallback(data: ObjectResolver.IWatchResultObject<AccessControl[]>): void;
    /**
     ...
     */
    setTrigger(valueNew: Trigger[] | null): void;
    /**
     * Returns the current trigger value.
     */
    getTrigger(): Trigger[] | null | undefined;
    /**
     ...
     */
    protected __onResolverForVirtualControlRightMappingsWatchCallback(data: ObjectResolver.IWatchResultObject<VirtualControlRightMapping[]>): void;
    /**
    ...
    /**
     * Returns the GridItemLayout value of the control inside a TcHmiGridContainer control.
     * @preserve (Part of the public API)
     */
    getGridItemLayout(): GridItemLayout | null | undefined;
    /**
     * Sets a new GridItemLayout value
     * @param valueNew
     * @preserve (Part of the public API)
     */
    setGridItemLayout(valueNew: GridItemLayout | null): void;
    /**
     * The watch callback for the gridItemLayout object resolver.
     */
    protected __onResolverForGridItemLayoutWatchCallback(data: ObjectResolver.IWatchResultObject<GridItemLayout | null>): void;
    /**
     * Process GridItemLayout
     */
    protected __processGridItemLayout(fromInit?: boolean): void;
    /**
     * Returns the FlexItemLayout value of the control inside a TcHmiFlexContainer control.
     * @preserve (Part of the public API)
     */
    getFlexItemLayout(): FlexItemLayout | null | undefined;
    /**
     * Sets a new FlexItemLayout value
     * @param valueNew
     * @preserve (Part of the public API)
     */
    setFlexItemLayout(valueNew: FlexItemLayout | null): void;
    /**
     * The watch callback for the flexItemLayout object resolver.
     */
    protected __onResolverForFlexItemLayoutWatchCallback(data: ObjectResolver.IWatchResultObject<FlexItemLayout | null>): void;
    /**
     * Process FlexItemLayout
     */
    protected __processFlexItemLayout(fromInit?: boolean): void;
    /**
     ...
     * @preserve (Part of the public API)
     */
    getParent(): baseTcHmiControl | null;
    /**
     * Sets __parent
     * @param value
     */
    __setParent(value: baseTcHmiControl | null): void;
    /**
     ...
     */
    protected __onResolverForTransformWatchCallback(data: ObjectResolver.IWatchResultObject<Transform[] | null>): void;
    /**
     ...
     */
    protected __onResolverForBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color | null>): void;
    /**
     ...
     */
    protected __onResolverForBackgroundImagePaddingWatchCallback(data: ObjectResolver.IWatchResultObject<FourSidedCss | null>): void;
    /**
     ...
     * @preserve (Part of the public API)
     */
    setBackgroundImageHorizontalAlignment(valueNew: HorizontalAlignment | null): void;
    /**
     ...
     */
    protected __onResolverForBorderColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color | null>): void;
    /**
     ...
     * @preserve (Part of the public API)
     */
    getBorderWidth(): import("../../../API/_Types.js").PixelFourSidedCss | null | undefined;
    /**
     ...
     */
    protected __onResolverForBorderWidthWatchCallback(data: ObjectResolver.IWatchResultObject<BorderWidth | null>): void;
    /**
     ...
     */
    protected __onResolverForBorderRadiusWatchCallback(data: ObjectResolver.IWatchResultObject<BorderRadius | null>): void;
    /**
     ...
     */
    protected __onResolverForBorderStyleWatchCallback(data: ObjectResolver.IWatchResultObject<BorderStyle | null>): void;
    /**
     ...
     */
    protected __onResolverForBoxShadowWatchCallback(data: ObjectResolver.IWatchResultObject<BoxShadow[] | null>): void;
    /**
...
export type FlexAlignSelf = 'Auto' | 'Stretch' | 'Center' | 'Flex-Start' | 'Flex-End' | 'Baseline';
export interface FlexItemLayout {
    flex?: string;
    order?: number;
    alignSelf?: FlexAlignSelf;
}
export type GridJustifyAlignSelf = 'Auto' | 'Stretch' | 'Center' | 'Start' | 'End';
