import { type AccessControl, type Color, Controls, type DestroyFunction, ObjectResolver, type SizeModeWithContent, type SolidColor, TcHmiControl } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiNavigationContent extends TcHmiControl.Control {
     ...
     * The watch callback for the textColor object resolver.
     */
    protected __onResolverForMenuBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color | null>): void;
    ...
    protected __getSubRights(dataObject: MenuItem[] | undefined, accessList: AccessControl[]): AccessControl[];
