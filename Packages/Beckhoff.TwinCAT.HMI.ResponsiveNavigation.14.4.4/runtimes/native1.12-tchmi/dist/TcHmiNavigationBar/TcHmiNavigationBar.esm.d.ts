import { TcHmiControl, type DestroyFunction, Symbol, type SolidColor, TcHmiRegion, EventProvider, ObjectResolver, Controls, type AccessControl } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiNavigationBar extends TcHmiControl.Control {
    ...
    protected __onResizedEventDestroyer: DestroyFunction | null;
    ...
    protected __menuSourceData: MenuItem[] | undefined | null;
    ...
    protected __targetRegionControl: TcHmiRegion.Control | null | undefined;
    protected __navContentControlSymbolDestroyWatch: DestroyFunction | null | undefined;
    protected __navContentControlSymbol: Symbol<TcHmiNavigationContent> | null | undefined;
    protected __breadCrumbControlSymbolDestroyWatch: DestroyFunction | null | undefined;
    protected __breadCrumbControlSymbol: Symbol<TcHmiBreadcrumb> | null | undefined;
    protected __targetRegionControlSymbolDestroyWatch: DestroyFunction | null | undefined;
    protected __targetRegionControlSymbol: Symbol<TcHmiRegion.Control> | null | undefined;
    ...
    protected __onResolverForMenuSourceDataCallback(data: ObjectResolver.IWatchResultObject<MenuItem[] | null>): void;
     ...
     */
    protected __onResolverForHighLightColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | null>): void;
     ...
     * The watch callback for the textColor object resolver.
     */
    protected __onResolverForFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | null>): void;
     ...
     * The watch callback for the textColor object resolver.
     */
    protected __onResolverForTriangleColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | null>): void;
     ...
     */
    setNavContentControlSymbol(valueNew: Symbol<TcHmiNavigationContent> | null): void;
    /**
    ...
    protected __onNavContentControlSymbolWatch(data: Symbol.IReadResultObject<TcHmiNavigationContent>): void;
    /**
     * BreadCrumbControlSymbol setter
     * @param valueNew The new value for breadcrumbControlSymbol.
     */
    setBreadCrumbControlSymbol(valueNew: Symbol<TcHmiBreadcrumb> | null): void;
    /**
    ...
    protected __onBreadCrumbControlSymbolWatch(data: Symbol.IReadResultObject<TcHmiBreadcrumb>): void;
    /**
     * DEPRECATED
     * @deprecated
     * @param valueNew The new value for targetRegionControl.
     */
    setTargetRegionControl(valueNew: TcHmiRegion.Control | null): void;
    /**
     * DEPRECATED
     * @deprecated
     */
    getTargetRegionControl(): TcHmiRegion.Control | null | undefined;
    /**
     * TargetRegionControlSymbol setter
     * @param valueNew The new value for targetRegionControlSymbol.
     */
    setTargetRegionControlSymbol(valueNew: Symbol<TcHmiRegion.Control> | null): void;
    /**
     * TargetRegionControlSymbol getter
     */
    getTargetRegionControlSymbol(): Symbol<TcHmiRegion.Control> | null | undefined;
    protected __processTargetRegionControlSymbol(ctrl?: TcHmiRegion.Control | null): void;
    protected __onTargetRegionControlSymbol(data: Symbol.IReadResultObject<TcHmiRegion.Control>): void;
