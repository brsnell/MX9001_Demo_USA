import { Controls, type DestroyFunction, EventProvider, type IErrorDetails, type IResultObject, type Locale, ObjectResolver, Server, TcHmiControl, Symbol } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import type { TcHmiButton, TcHmiTextblock, TcHmiCombobox, TcHmiCheckbox, TcHmiNumericInput, TcHmiDatagrid, Helpers } from 'Beckhoff.TwinCAT.HMI.Controls/index.esm.js';
declare class TcHmiMotionControl extends TcHmiControl.Control {
    ...
    protected __allowedAxes: number[] | null | undefined;
    ...
    protected __mcPowerSymbol: Symbol<McPower | undefined | null> | undefined | null;
    protected __mcMoveAbsoluteSymbol: Symbol<McMoveAbsolute | undefined | null> | undefined | null;
    protected __McMoveVelocitySymbol: Symbol<McMoveVelocity | undefined | null> | undefined | null;
    protected __mcResetSymbol: Symbol<McReset | undefined | null> | undefined | null;
    protected __mcHaltSymbol: Symbol<McHalt | undefined | null> | undefined | null;
    protected __mcHomeSymbol: Symbol<McHome | undefined | null> | undefined | null;
    ...
    protected __dataSourceMode: 'NC' | 'NC & PLC' | null | undefined;
     ...
     */
    protected __onNcDataSubscription(data: Server.IResultObject<NcReadRequest, string>): void;
    ...
    /**
     * Selects the axis with the given NC axis id. In contrast to setCurrentAxis, which expects the position
     * of the axis inside the axis combobox, this function takes the actual NC axis id and translates it to the
     * corresponding combobox position. The axis must be part of the currently available axes, which already
     * respects the configured allowed axes. The returned result object reports Errors.NONE on success or an
     * error code with details describing why the axis could not be selected.
     * @param axisId The NC axis id to select.
     */
    selectAxisById(axisId: number | null): IResultObject;
    /**
    ...
    /**
     * Setter function for 'data-tchmi-allowed-axes' attribute.
     * @param valueNew The new list of allowed axis IDs. If null, all axes are available.
     */
    setAllowedAxes(valueNew: number[] | null): void;
    /**
     * The watch callback for the AllowedAxes object resolver.
     */
    protected __onResolverForAllowedAxesWatchCallback(data: ObjectResolver.IWatchResultObject<number[] | null>): void;
    /**
     * Getter function for 'data-tchmi-allowed-axes' attribute.
     */
    getAllowedAxes(): number[] | null | undefined;
    protected __processAllowedAxes(): void;
    /**
     ...
     */
    protected __onResolverForAxisRefWatchCallback(data: ObjectResolver.IWatchResultObject<AxisRef | null>): void;
    /**
     ...
     */
    setMcPower(valueNew: Symbol<McPower | null>): void;
    /**
     * Returns the current value of McPower.
     * @returns The current value of McPower.
     */
    getMcPower(): Symbol<McPower | null | undefined> | null | undefined;
    /**
     ...
     */
    setMcMoveAbsolute(valueNew: Symbol<McMoveAbsolute | null>): void;
    /**
     * Returns the current value of McMoveAbsolute.
     * @returns The current value of McMoveAbsolute.
     */
    getMcMoveAbsolute(): Symbol<McMoveAbsolute | null | undefined> | null | undefined;
    /**
     ...
     */
    setMcMoveVelocity(valueNew: Symbol<McMoveVelocity | null>): void;
    /**
     * Returns the current value of McMoveVelocity.
     * @returns The current value of McMoveVelocity.
     */
    getMcMoveVelocity(): Symbol<McMoveVelocity | null | undefined> | null | undefined;
    /**
     ...
     */
    setMcReset(valueNew: Symbol<McReset | null>): void;
    /**
     * Returns the current value of McReset.
     * @returns The current value of McReset.
     */
    getMcReset(): Symbol<McReset | null | undefined> | null | undefined;
    /**
     ...
     */
    setMcHalt(valueNew: Symbol<McHalt | null>): void;
    /**
     * Returns the current value of McHalt.
     * @returns The current value of McHalt.
     */
    getMcHalt(): Symbol<McHalt | null | undefined> | null | undefined;
    /**
     * Processes the current value of attribute McHalt.
     */
    protected __processHalt(): void;
    /**
     * Sets the value of the member variable "DataSourceMode".
     * @param valueNew The new value for DataSourceMode ('NC' or 'NC & PLC').
     */
    setDataSourceMode(valueNew: 'NC' | 'NC & PLC' | null): void;
    /**
     * Returns the current value of DataSourceMode.
     */
    getDataSourceMode(): "NC" | "NC & PLC" | null | undefined;
    /**
     * Processes the current value of attribute DataSourceMode, updates the PLC subscription and gets the PLC data if necessary.
     */
    protected __processDataSourceMode(): void;
    /**
     * Sets the content value and calls the associated process function.
     * @param valueNew The new value for the McHome attribute.
     */
    setMcHome(valueNew: Symbol<McHome | null>): void;
    /**
     * Returns the current value of McHome.
     * @returns The current value of McHome.
     */
    getMcHome(): Symbol<McHome | null | undefined> | null | undefined;
    /**
