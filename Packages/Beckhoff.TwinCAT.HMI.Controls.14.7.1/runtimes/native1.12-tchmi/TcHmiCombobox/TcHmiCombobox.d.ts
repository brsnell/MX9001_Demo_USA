 ...
 */
declare class TcHmiCombobox<T extends any = any, D extends ListItemGeneric<T>[] | T[] | Dictionary<T> = ListItemGeneric<T>[] | T[] | Dictionary<T>> extends TcHmi.Controls.System.TcHmiControl {
    #private;
