import { Controls, EventProvider, Locale, ObjectResolver, Server, TcHmiControl, type FontFamily, type FontWeight, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import { type LineAreaGraphPoint, AxisPosition, ChartPosition } from '../TcHmiCharting/Types.js';
...
declare class TcHmiTrendSparkline extends TcHmiControl.Control {
    ...
    protected __yAxisColor: SolidColor | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-y-axis-position' */
    protected __yAxisPosition: keyof typeof ChartPosition | undefined;
    ...
    /** Internal reference to the attribute 'data-tchmi-mirror-y-axis' */
    protected __mirrorYAxis: boolean | undefined;
    ...
    protected __lineGraphData: LineAreaGraphPoint[][] | null;
    ...
    /** Linechart elements' */
    protected __lineCharts: LineAreaChart[];
    /** Reconnect timer */
    ...
    protected __onResolverForHistorizedSymbolsWatchCallback(data: ObjectResolver.IWatchResultObject<HistorizedSymbols[]>): void;
     ...
     */
    setLabelPosition(valueNew: keyof typeof LabelPosition | null): void;
    ...
    protected __onResolverForYAxisColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
     ...
     */
    setYAxisPosition(valueNew: keyof typeof ChartPosition | null): void;
    /** Gets the value of yAxisPosition */
    getYAxisPosition(): "Background" | "Foreground" | undefined;
    ...
    /**
     * Sets whether the Y-axis direction is mirrored.
     * @param valueNew The new mirrorYAxis value.
     */
    setMirrorYAxis(valueNew: boolean | null): void;
    /**
     * Gets the value of mirrorYAxis.
     * @returns The current value of mirrorYAxis.
     */
    getMirrorYAxis(): boolean | undefined;
    /**
     * Processes mirrorYAxis.
     */
    protected __processMirrorYAxis(): void;
    /**
