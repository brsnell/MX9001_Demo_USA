import { Controls, EventProvider, FilterInstance, type Locale, LocalStorage, ObjectResolver, Server, TcHmiControl, type Color, type Filter, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type HorizontalAlignment, type SolidColor, type VerticalAlignment, type VirtualControlRightMapping, type IFunction } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import type * as TcHmiDatagrid from '../TcHmiDatagrid/TcHmiDatagrid.esm.js';
import { Menubar } from './Menubar.js';
import { LineAreaChart } from '../TcHmiCharting/LineAreaChart.js';
import type { ReferenceLine as ReferenceLineCharting } from '../TcHmiCharting/ReferenceLine.js';
import { AxisPosition, Orientation } from '../TcHmiCharting/Types.js';
...
declare class TcHmiTrendLineChart extends TcHmiControl.Control {
    ...
    /** Linechart element' */
    protected __lineChart: LineAreaChart | null;
    ...
    protected __sectionsBackgroundColor: Color | null | undefined;
    ...
    protected __xLabelFontColor: SolidColor | null | undefined;
    ...
    protected __xAxisColor: SolidColor | null | undefined;
    ...
    protected __xAxisNameFontColor: SolidColor | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-value-format' */
    protected __xAxisFormat: IFunction.IFunction<string> | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-mirror-x-axis' */
    protected __mirrorXAxis: boolean | undefined;
    ...
    protected __gridBackgroundColor: SolidColor | null | undefined;
    ...
    protected __gridLineColor: SolidColor | null | undefined;
    ...
    protected __subgridLineColor: SolidColor | null | undefined;
    ...
    protected __menuBarLabelFontColor: SolidColor | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-show-tooltip' */
    protected __showTooltip: boolean | undefined;
    /** Internal variable for tooltipConfiguration */
    protected __tooltipConfiguration: TooltipConfiguration | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-tooltip-format' */
    protected __tooltipFormat: IFunction.IFunction<string> | null | undefined;
    ...
    protected __tooltipFontColor: SolidColor | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-tooltip-background-color' */
    protected __tooltipBackgroundColor: Color | null | undefined;
    ...
    /** Per line flag from historize-extension that marks lines which should be drawn as a step line (store only changed values). */
    protected __storeOnlyChangedValues: boolean[] | null;
    ...
    protected __manipulationInfo: {
        ...
        referenceLine: ReferenceLineCharting | null;
    };
    ...
    protected __tooltipInformation: {
        ...
        referenceLine: ReferenceLineCharting | undefined;
    };
    ...
    protected __rebuild(_event: EventProvider.Event, _ctrl?: TcHmiControl.Control): void;
    /** Unsubscribes from the current subscription and retries once if the server returns an error
     * (e.g. INVALID_PARAMETER when the subscribe was still pending on the server). */
    protected __unsubscribeWithRetry(): void;
    ...
    /**
     * Is raised on pointerdown on canvasDrawing. The chart consumes pan/zoom (incl. two-finger pinch) gestures, so
     * keep an enclosing TcHmiRegion from starting its own pan/pinch on the same pointer. Only stops propagation when
     * the chart would actually consume the gesture (same conditions as __onMouseDown/__onTouchStart), so a region
     * still receives the pointer when the chart is disabled, empty or showing the live (First/Latest) range.
    ...
    /**
     * Sets whether the X-axis direction is mirrored.
     * @param valueNew The new mirrorXAxis value.
     */
    setMirrorXAxis(valueNew: boolean | null): void;
    /**
     * Gets the value of mirrorXAxis.
     * @returns The current value of mirrorXAxis.
     */
    getMirrorXAxis(): boolean | undefined;
    /**
     * Processes mirrorXAxis.
     */
    protected __processMirrorXAxis(): void;
    /**
     * Sets the xAxis of the xAxisFormat order attribute.
     * @param xAxis The new xAxisFormat method.
     */
    setXAxisFormat(valueNew: IFunction.IFunction<string> | null): void;
    /** The watch callback for the xAxisFormat object resolver. */
    protected __onResolverForXAxisFormatWatchCallback(data: ObjectResolver.IWatchResultObject<IFunction.IFunction<string>>): void;
    /** Gets the current xAxisFormat method. */
    getXAxisFormat(): IFunction.IFunction<string> | null | undefined;
    ...
    protected __onResolverForSectionsBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    ...
    protected __onResolverForXLabelFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    ...
    protected __onResolverForXAxisColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    ...
    protected __onResolverForXAxisNameFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    ...
    protected __onResolverForYAxisWatchCallback(data: ObjectResolver.IWatchResultObject<YAxis[]>): void;
    ...
    protected __onResolverForLineGraphDescriptionsWatchCallback(data: ObjectResolver.IWatchResultObject<LineGraphDescription[]>): void;
    ...
    protected __onResolverForGridBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    ...
    protected __onResolverForGridLineColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    ...
    protected __onResolverForSubgridLineColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    ...
    protected __onResolverForMenuBarLabelFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | null>): void;
    ...
    /**
     * Sets the value of the member variable 'tooltipConfiguration' if the new value is not equal to the current value
     * and calls the associated process function (processTooltipConfiguration) after that.
     * @param valueNew The new value for tooltipConfiguration.
     */
    setTooltipConfiguration(valueNew: TooltipConfiguration | null): void;
    /** The watch callback for the tooltipConfigurationConfiguration object resolver. */
    protected __onResolverForTooltipConfigurationWatchCallback(data: ObjectResolver.IWatchResultObject<TooltipConfiguration>): void;
    /** Returns the current value of the member variable tooltipConfiguration. */
    getTooltipConfiguration(): TooltipConfiguration | null | undefined;
    /** Processes the current value of tooltipConfiguration. */
    __processTooltipConfiguration(): void;
    /**
     * Sets the value of the tooltipFormat order attribute.
     * @param value The new tooltipFormat method.
     */
    setTooltipFormat(valueNew: IFunction.IFunction<string> | null): void;
    /** The watch callback for the tooltipFormat object resolver. */
    protected __onResolverForTooltipFormatWatchCallback(data: ObjectResolver.IWatchResultObject<IFunction.IFunction<string>>): void;
    /** Gets the current tooltipFormat method. */
    getTooltipFormat(): IFunction.IFunction<string> | null | undefined;
     ...
     */
    protected __executeYAxisFormatFunction(format: IFunction.IFunction<string> | undefined, value: number): string | null;
    /**
    ...
    protected __onResolverForTooltipFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    ...
    protected __onResolverForTooltipBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /** Returns the current background value. */
    ...
    protected __onResolverForStartPresetsWatchCallback(data: ObjectResolver.IWatchResultObject<TimeOrTimespanPreset[]>): void;
    ...
    protected __onResolverForEndPresetsWatchCallback(data: ObjectResolver.IWatchResultObject<TimeOrTimespanPreset[]>): void;
    ...
    protected __onResolverForReferenceLinesWatchCallback(data: ObjectResolver.IWatchResultObject<ReferenceLine[]>): void;
    ...
    protected __onResolverForStatisticalDataConfigurationWatchCallback(data: ObjectResolver.IWatchResultObject<StatisticalDataConfiguration>): void;
    ...
    static Position: typeof AxisPosition;
...
export interface YAxis {
    ...
    showLabels?: boolean;
    labelFontColor?: SolidColor;
    axisColor?: SolidColor;
    showAxisName?: boolean;
    axisName?: string;
    axisNameFontFamily?: FontFamily | null;
    axisNameFontSize?: number;
    axisNameFontSizeUnit?: FontSizeUnit;
    axisNameFontWeight?: FontWeight;
    axisNameFontColor?: SolidColor;
    decimalPlaces?: number;
    unit?: string;
    autoScaling?: boolean;
    showAxisIfNoData?: boolean;
    format?: IFunction.IFunction<string> | null | undefined;
    mirrorAxis?: boolean;
}
...
export interface LineGraphDescription {
    ...
    pointDotFillColor?: SolidColor;
    pointDotStrokeWidth?: number;
    pointDotStrokeColor?: SolidColor;
    scaleFactor?: number;
    fillMode?: FillMode;
...
export interface ReferenceLine {
    ...
    labelFontSizeUnit?: FontSizeUnit;
