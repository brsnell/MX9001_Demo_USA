import { Controls, type Keyboard, Locale, ObjectResolver, Symbol, type SymbolExpression, TcHmiControl, type Color, type DestroyFunction, type Dictionary, type DimensionUnit, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HorizontalAlignment, type JsonSchema, type SolidColor, type VerticalAlignment } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
 ...
 */
declare class TcHmiCombobox<T extends any = any, D extends ListItemGeneric<T>[] | T[] | Dictionary<T> = ListItemGeneric<T>[] | T[] | Dictionary<T>> extends TcHmiControl.Control {
    #private;
    ...
    protected __elementText: JQuery<HTMLSpanElement | HTMLInputElement>;
    ...
    protected __systemKeyboardInputMode: Keyboard.KeyboardInputMode | undefined;
    /** SelectedIndex */
    ...
    /** Internal reference to the attribute "data-tchmi-enable-search-filter" */
    protected __enableSearchFilter: boolean | undefined;
    protected __searchFilterText: string;
    protected __elementSearchFilterInput: HTMLInputElement | undefined;
    protected __cursorPosition: number | null | undefined;
     ...
     */
    protected __onItemClick(event: Event): void;
    /**
     * Is raised if mouse enter to the combobox element.
     */
    protected __onMouseEnter(event: Event): void;
    /**
     * Is raised if mouse leave the combobox element.
     */
    protected __onMouseLeave(event: Event): void;
    /**
     ...
     */
    protected __onResolverForDropDownHighlightColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForDropDownHighlightTextColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForDropDownToggleButtonBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForDropDownToggleButtonArrowColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForTextColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForSrcDataWatchCallback(data: ObjectResolver.IWatchResultObject<D>): void;
    /**
     ...
     * @param valueNew
     */
    setEnumDataSymbol(valueNew: Symbol<T[]> | null): void;
    /**
     */
    ...
    protected __onEnumDataSymbolWatch(data: Symbol.IReadResultObject<number>): void;
     ...
     */
    protected __onResolverForDropDownTextColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForDropDownBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    setSystemKeyboardInputMode(valueNew: Keyboard.KeyboardInputMode | null): void;
    /**
     ...
     */
    protected __onResolverForDropDownCategoryTextColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForDropDownCategoryBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
    ...
    /**
     * Sets the value of the member variable EnableSearchFilter.
     * @param valueNew The new value for EnableSearchFilter
     */
    setEnableSearchFilter(valueNew: boolean | null | undefined): void;
    protected __processEnableSearchFilter(): void;
    /**
     * Returns the current value of EnableSearchFilter.
     * @returns The current value of EnableSearchFilter.
     */
    getEnableSearchFilter(): boolean | undefined;
    protected __createOrRemoveSearchElement(): void;
    /**
     * Handles the search input event.
     * @param event The input event.
     * @returns
     */
    protected __onSearchInput(event: Event): void;
    /**
...
type tTcHmiCombobox<T extends any = any, D extends tListItemGeneric<T>[] | T[] | Dictionary<T> = tListItemGeneric<T>[] | T[] | Dictionary<T>> = TcHmiCombobox<T, D>;
...
declare global {
    namespace TcHmi.Controls.Beckhoff {
        ...
        type TcHmiCombobox<T extends any = any, D extends tListItemGeneric<T>[] | T[] | Dictionary<T> = tListItemGeneric<T>[] | T[] | Dictionary<T>> = tTcHmiCombobox<T, D>;
