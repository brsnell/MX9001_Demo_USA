declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiTrendLineChart extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __statisticalDataConfiguration: TcHmiTrendLineChart.StatisticalDataConfiguration | null | undefined;
         ...
         */
        setStatisticalDataConfiguration(valueNew: TcHmiTrendLineChart.StatisticalDataConfiguration | null): void;
        /** The watch callback for the statisticalDataConfiguration object resolver. */
        protected __onResolverForStatisticalDataConfigurationWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<TcHmiTrendLineChart.StatisticalDataConfiguration>): void;
        /** Returns the current value of the member variable statisticalDataConfiguration. */
        getStatisticalDataConfiguration(): TcHmiTrendLineChart.StatisticalDataConfiguration | null | undefined;
