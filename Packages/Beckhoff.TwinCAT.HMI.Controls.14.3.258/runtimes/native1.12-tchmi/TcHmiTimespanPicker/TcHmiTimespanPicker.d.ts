declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiTimespanPicker extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __timeUnits: TcHmiTimespanPicker.TimeUnits | null | undefined;
        /**
        ...
        protected __onResolverForTimeUnitsWatchCallback(data: Symbol.ObjectResolver.IWatchResultObject<TcHmiTimespanPicker.TimeUnits>): void;
        /** Returns the current value of the member variable timeUnits. */
        getTimeUnits(): TcHmiTimespanPicker.TimeUnits | null | undefined;
