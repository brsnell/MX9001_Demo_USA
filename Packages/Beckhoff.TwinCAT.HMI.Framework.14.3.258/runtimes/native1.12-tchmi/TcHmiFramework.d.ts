...
declare namespace TcHmi {
    ...
    namespace Config {
         ...
         * @preserve (Part of the public API)
         */
        function getNugetPackagesMetadata(): TcHmi.Dictionary<TcHmi.Config.NugetPackageMetadata>;
    }
}
declare namespace TcHmi {
    /**
    ...
    namespace Access {
         ...
         */
        function setControlRightOverride(control: Readonly<TcHmi.Controls.System.baseTcHmiControl>, accessrightToOverride: string, forcedRight: 'Deny' | null): boolean;
        /**
         * Returns a Set with a list of all overridden deny rights for a control.
         * Gives an empty Set when no right is overridden.
         * @param control Control to check
         */
        function getControlRightOverrides(control: Readonly<TcHmi.Controls.System.baseTcHmiControl>): Set<string>;
    }
}
declare namespace TcHmi {
    /**
...
declare namespace TcHmi {
    ...
    namespace Binding {
         ...
         * @preserve (Part of the public API)
         */
        function createEx2(expression: string, propertyName: string, control: TcHmi.Controls.System.baseTcHmiControl, options?: {
            ctx?: TcHmi.Context;
        }): void;
        /**
...
declare namespace TcHmi {
    ...
    namespace ControlFactory {
         ...
         * @preserve (Part of the public API)
         */
        function createEx<C extends TcHmi.Controls.System.baseTcHmiControl>(type: string, id: string, attributes: null | TcHmi.Dictionary<any>, parent?: TcHmi.Controls.System.baseTcHmiControl | null): C | undefined;
...
declare namespace TcHmi.Controls {
     ...
     * @preserve (Part of the public API)
     */
    function getVersion(type: string): TcHmi.Version | null;
    /**
...
declare namespace TcHmi {
    ...
    namespace EventProvider {
         ...
         * @param callback Callback which will be called
         */
        function watchEventRegistration(name: string, callback: (data: EventProvider.IEventRegResultObject) => void): TcHmi.DestroyFunction;
        /**
         ...
         */
        function registerDomEvent<K extends keyof HTMLElementEventMap>(element: Element | Document | Window | Iterable<Element>, type: K, listener: (this: EventTarget, event: HTMLElementEventMap[K]) => void, options?: AddEventListenerOptions): TcHmi.DestroyFunction;
        /**
         * Registers an event on DOM elements and returns an easy to use DestroyFunction to remove the event later.
         * @param element The element or elements to register the event on.
         * @param type The type of event to register.
         ...
         * @param options Options for the event registrations. Defaults to { passive: true }.
         */
        function registerDomEvent(element: Element | Document | Window | Iterable<Element>, type: string, listener: (this: EventTarget, event: globalThis.Event) => void, options?: AddEventListenerOptions): TcHmi.DestroyFunction;
...
declare namespace TcHmi {
    ...
    namespace FileUploader {
        ...
        interface ProgressResultSuccess extends TcHmi.IResultObject {
            error: TcHmi.Errors.NONE;
            uploadedBytes: number;
            totalBytes: number;
            status: FileStatus;
        }
        interface ProgressResultFail extends TcHmi.IResultObject {
...
declare namespace TcHmi.Functions {
     ...
     * @preserve (Part of the public API)
     */
    function getFunctionVersion(name: string): TcHmi.Version | null;
}
declare namespace TcHmi {
    /**
    ...
    namespace Keyboard {
         ...
         */
        function getProjectKeyboardMapping(): TcHmi.Dictionary<TcHmi.Keyboard.InputModeMapping>;
        /**
         ...
         */
        function setProjectKeyboardMapping(projectKeyboardMapping: TcHmi.Dictionary<TcHmi.Keyboard.InputModeMapping>): void;
        /**
         * Gets the layout object of the system keyboard container.
         */
        function getContainerLayout(): TcHmi.Keyboard.ContainerLayout | null;
        /**
         ...
         */
        function setContainerLayout(layout: TcHmi.Keyboard.ContainerLayout): void;
        interface LayoutResultSuccess extends TcHmi.IResultObject {
            error: TcHmi.Errors.NONE;
            layoutUrl: string;
        }
        interface LayoutResultFail extends TcHmi.IResultObject {
            error: Exclude<TcHmi.Errors, TcHmi.Errors.NONE>;
            details: TcHmi.SelectableRequired<TcHmi.IErrorDetails, 'message' | 'reason' | 'domain'>;
        }
...
declare namespace TcHmi.Server {
    ...
    namespace Events {
         ...
         */
        export function registerConsumer(filter: TcHmi.Filter | null, callbacks: {
...
declare namespace TcHmi.Server {
    ...
    namespace Domains {
         ...
         */
        function watch(name: string, callback?: (data: TcHmi.Server.Domains.IServerWatchResultObject<Domains.IDomainInfo>) => void): TcHmi.DestroyFunction;
...
declare namespace TcHmi.Server {
    ...
    namespace Historize {
         ...
         * @preserve (Part of the public API)
         */
        function removeEx(symbolName: string, requestOptions: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
         * Removing a Symbol from the Historize Configuration of the server
         * @param symbolName Name of the Symbol to manipulate
         * @param options global settings
         ...
         * @preserve (Part of the public API)
         */
        function removeEx2(symbolName: string, options: TcHmi.Server.Historize.IOptions | null, requestOptions: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function updateEx(symbolName: string, settings: TcHmi.Server.Historize.IEntrySettings, requestOptions: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
         * Update a config of a Symbol in the Historize Configuration of the server
         * @param symbolName Name of the Symbol to manipulate
         * @param settings Settings for the symbol
...
declare namespace TcHmi.Server {
    ...
    namespace RecipeManagement {
         ...
         * @preserve (Part of the public API)
         */
        function listRecipeTypesEx(options?: RecipeManagement.IRecipeListOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.Server.RecipeManagement.IRecipeTypeListResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function updateRecipe(recipeName: string, path: string | null, newValues: TcHmi.Dictionary<any>, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
         * Updates a recipe
         * This function provides more options to manipulate the request
         * @param recipeName Name of the recipe (could be prefixed with a path if separated with ::)
         ...
         * @preserve (Part of the public API)
         */
        function updateRecipeEx(recipeName: string, path: string | null, newValues: TcHmi.Dictionary<any>, options?: RecipeManagement.IRecipeOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function readFromTargetEx(recipeName: string, path: string | null, options?: RecipeManagement.IRecipeOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.Server.RecipeManagement.IReadFromTargetResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function teachAsNewRecipeEx(recipeName: string, path: string | null, newRecipeName: string, newRecipePath: string | null, options?: RecipeManagement.IRecipeOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function getActiveRecipesEx(options?: RecipeManagement.IRecipeOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.Server.RecipeManagement.IGetActiveRecipesResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function renameRecipeEx(recipeName: string, path: string | null, newName: string, newPath: string | null, options?: RecipeManagement.IRecipeOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
...
declare namespace TcHmi {
    ...
    namespace Server {
         ...
         * @template R Type of the read value.Use 'any' (or omit) if this interface contains multiple different types.
         */
        interface IValueResultObject<R = any> extends IResultObject {
            symbol?: string;
            value?: R;
        }
        /**
...
declare namespace TcHmi.Server {
    ...
    namespace UserManagement {
         ...
         * @preserve (Part of the public API)
         */
        function addUserEx(userName: string, password: string, options?: Partial<TcHmi.Server.UserManagement.IUserDetails> | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.IResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function listUsersEx(options?: TcHmi.Server.UserManagement.IUserManagementOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.Server.UserManagement.IUserResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function listUserGroupsEx(_options?: TcHmi.Dictionary<never> | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.Server.UserManagement.IGroupResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function listUserGroupNamesEx(_options?: TcHmi.Dictionary<never> | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.Server.UserManagement.GroupNamesResultObject) => void)): TcHmi.IErrorDetails;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function listUsersInGroupEx(groupName: string, options?: TcHmi.Server.UserManagement.IUserManagementOptions | null, requestOptions?: Server.IRequestOptions | null, callback?: null | ((this: void, data: TcHmi.Server.UserManagement.IUsernameListResultObject) => void)): TcHmi.IErrorDetails;
        /**
         * Removes a user
...
declare namespace TcHmi {
    ...
    namespace StyleProvider {
         ...
         */
        function getComputedElementStyle(element: Iterable<Element> | Element | undefined): TcHmi.Dictionary<string>;
        /**
         ...
         * @param element The jQuery collection or HTML/SVG element(s) to operate with.
         */
        function getSimpleElementStyle(element: Iterable<Element> | Element | undefined): TcHmi.Dictionary<string>;
        /**
         ...
         */
        function setSimpleElementStyle(element: Iterable<Element> | Element | undefined, styles: Readonly<TcHmi.Dictionary<string | readonly string[] | null | undefined>> | null): void;
        /**
         ...
         */
        function processGenericStyle(controlName: string, selector: string, styles: TcHmi.Dictionary<string | string[] | null>): void;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function resolveSolidColorAsRGBA(colorObject: TcHmi.SolidColor): TcHmi.RGBAColor;
        /**
...
declare namespace TcHmi {
    ...
    class Symbol<ST = any> extends TcHmi.Destroyable {
         ...
         * @preserve (Part of the public API)
         */
        static readEx<T = any>(expressionObject: Symbol.ExpressionContainer): T | undefined;
        /**
         * Reads the value of a symbol by expression.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @template T Type of the read value.
         * @preserve (Part of the public API)
         */
        static readEx<T = any>(expressionOrExpressionObject: string | Symbol.ExpressionContainer): T | undefined;
        /**
         ...
         * @preserve (Part of the public API)
         */
        static readEx2<T = any>(expressionObject: Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IReadResultObject<T> | Symbol.IServerReadResultObject<T>) => void): DestroyFunction;
        /**
         * Reads the value of a symbol by expression and raises a callback with the result.
         * Returns a destroy function to terminate reading of asynchronous values.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         ...
         * @preserve (Part of the public API)
         */
        static readEx2<T = any>(expressionOrExpressionObject: string | Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IReadResultObject<T> | Symbol.IServerReadResultObject<T>) => void): DestroyFunction;
        /**
         * Reads the value of a symbol by expression and raises a callback with the result.
         * Returns a destroy function to terminate reading of asynchronous values.
         * @param expression Expression for the symbol
         ...
         * @preserve (Part of the public API)
         */
        static readEx3<T = any>(expressionObject: Symbol.ExpressionContainer, options: TcHmi.Symbol.IOptions | null, callback?: (this: void, data: TcHmi.Symbol.IReadResultObject<T> | Symbol.IServerReadResultObject<T>) => void): DestroyFunction;
        /**
         * Reads the value of a symbol by expression and raises a callback with the result.
         * Returns a destroy function to terminate reading of asynchronous values.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         ...
         * @preserve (Part of the public API)
         */
        static readEx3<T = any>(expressionOrExpressionObject: string | Symbol.ExpressionContainer, options: TcHmi.Symbol.IOptions | null, callback?: (this: void, data: TcHmi.Symbol.IReadResultObject<T> | Symbol.IServerReadResultObject<T>) => void): DestroyFunction;
        /**
         ...
         * @preserve (Part of the public API)
         */
        static writeEx<T = any>(expressionObject: Symbol.ExpressionContainer, value: T, callback?: null | ((this: void, data: Symbol.IWriteResultObject<T> | TcHmi.Symbol.IServerWriteResultObject<T>) => void)): DestroyFunction;
        /**
         * Writes the value of a symbol by expression.
         * Returns a destroy function to terminate writing of asynchronous values.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         ...
         * @preserve (Part of the public API)
         */
        static writeEx<T = any>(expressionOrExpressionObject: string | Symbol.ExpressionContainer, value: T, callback?: null | ((this: void, data: Symbol.IWriteResultObject<T> | TcHmi.Symbol.IServerWriteResultObject<T>) => void)): DestroyFunction;
        /**
         * Writes the value of a symbol by expression.
         * Returns a destroy function to terminate writing of asynchronous values.
         * @param expression Expression for the symbol
         ...
         * @preserve (Part of the public API)
         */
        static writeEx2<T = any>(expressionObject: Symbol.ExpressionContainer, value: T, options: Symbol.IOptions | null, callback?: null | ((this: void, data: Symbol.IWriteResultObject<T> | TcHmi.Symbol.IServerWriteResultObject<T>) => void)): DestroyFunction;
        /**
         * Writes the value of a symbol by expression.
         * Returns a destroy function to terminate writing of asynchronous values.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         ...
         * @preserve (Part of the public API)
         */
        static writeEx2<T = any>(expressionOrExpressionObject: string | Symbol.ExpressionContainer, value: T, options: Symbol.IOptions | null, callback?: null | ((this: void, data: Symbol.IWriteResultObject<T> | TcHmi.Symbol.IServerWriteResultObject<T>) => void)): DestroyFunction;
        /**
         ...
         * @preserve (Part of the public API)
         */
        static resolveExpression(expressionObject: Symbol.ExpressionContainer, callback: (data: TcHmi.Symbol.IReadResultObject<TcHmi.SymbolExpression>) => void): void;
        /**
         * Resolves the expression.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @param callback Callback will be called after success (with the schema) or failure
         * @preserve (Part of the public API)
         */
        static resolveExpression(expressionOrExpressionObject: string | Symbol.ExpressionContainer, callback: (data: TcHmi.Symbol.IReadResultObject<TcHmi.SymbolExpression>) => void): void;
        /**
         * Resolves the schema of the current symbol.
         * @param expression Expression for the symbol
         * @param callback Callback will be called after success or failure
         ...
         * @preserve (Part of the public API)
         */
        static resolveSchema(expressionObject: Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.ISchemaResultObject) => void): void;
        /**
         * Resolves the schema of the current symbol.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @param callback Callback will be called after success or failure
         * @preserve (Part of the public API)
         */
        static resolveSchema(expressionOrExpressionObject: string | Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.ISchemaResultObject) => void): void;
        /**
         * Resolves a dictionary of PLC (?) attributes from the underlying schema.
         * @param expression Expression for the symbol
         * @param callback Callback will be called after success or failure
         ...
         * @preserve (Part of the public API)
         */
        static resolveAttributes(expressionObject: Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IAttributesResultObject) => void): void;
        /**
         * Resolves a dictionary of PLC (?) attributes from the underlying schema.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @param callback Callback will be called after success or failure
         * @preserve (Part of the public API)
         */
        static resolveAttributes(expressionOrExpressionObject: string | Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IAttributesResultObject) => void): void;
        /**
         * Resolves a PLC (?) attribute by name from the underlying schema.
         * @param expression Expression for the symbol
         * @param name Name of the PLC (?) attribute
         ...
         * @preserve (Part of the public API)
         */
        static resolveAttribute(expressionObject: Symbol.ExpressionContainer, name: string, callback?: (this: void, data: TcHmi.Symbol.IAttributeResultObject) => void): void;
        /**
         * Resolves a PLC (?) attribute by name from the underlying schema.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @param name Name of the PLC (?) attribute
         ...
         * @preserve (Part of the public API)
         */
        static resolveAttribute(expressionOrExpressionObject: string | Symbol.ExpressionContainer, name: string, callback?: (this: void, data: TcHmi.Symbol.IAttributeResultObject) => void): void;
        /**
         * Resolves a list of available versions of the symbol.
         * @param expression Expression for the symbol
         * @param callback Callback will be called after success (with the list of version) or failure
         ...
         * @preserve (Part of the public API)
         */
        static resolveVersions(expressionObject: Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IVersionsResultObject) => void): void;
        /**
         * Resolves a list of available versions of the symbol.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @param callback Callback will be called after success (with the list of version) or failure
         * @preserve (Part of the public API)
         */
        static resolveVersions(expressionOrExpressionObject: string | Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IVersionsResultObject) => void): void;
        /**
         * Resolves the symbols meta data
         * @param expression Expression for the symbol
         * @param callback Callback will be called after success (with the meta data) or failure
         ...
         * @preserve (Part of the public API)
         */
        static resolveMetaData(expressionObject: Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IServerSymbolMetaDataResultObject) => void): void;
        /**
         * Resolves the symbols meta data
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @param callback Callback will be called after success (with the meta data) or failure
         * @preserve (Part of the public API)
         */
        static resolveMetaData(expressionOrExpressionObject: string | Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IServerSymbolMetaDataResultObject) => void): void;
        /**
         ...
         * @preserve (Part of the public API)
         */
        static exists(expressionObject: Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IExistsResultObject) => void): void;
        /**
         * Checks if a symbol exists.
         * @param expressionOrExpressionObject Expression meta data object including the expression itself and further information like context or string.
         * @param callback Callback will be called after success or failure
         * @preserve (Part of the public API)
         */
        static exists(expressionOrExpressionObject: string | Symbol.ExpressionContainer, callback?: (this: void, data: TcHmi.Symbol.IExistsResultObject) => void): void;
        /**
...
declare namespace TcHmi {
    ...
    class SymbolExpression {
         ...
         * @preserve (Part of the public API)
         */
        watch(callback: (data: TcHmi.Symbol.IReadResultObject<TcHmi.SymbolExpression>) => void): TcHmi.DestroyFunction;
    }
...
declare namespace TcHmi.Trigger {
    ...
    namespace Actions {
         ...
         */
        function run<T>(actions: TcHmi.Trigger.Action[], ctx?: TcHmi.Context<T>): Promise<T | undefined>;
    }
}
declare namespace TcHmi.Type {
     ...
     * @preserve (Part of the public API)
     */
    function getSchema(typeName: string): TcHmi.JsonSchema | null;
}
declare namespace TcHmi.Type {
    namespace Schema {
        /**
         ...
         * @preserve (Part of the public API)
         */
        function resolveType(schema: TcHmi.JsonSchema): undefined | TcHmi.JsonDataTypeNames | TcHmi.JsonDataTypeNames[];
        /**
         ...
         */
        function recurseThroughSchema<T = unknown>(schema: TcHmi.JsonSchema, data: T, action: (subschema: TcHmi.JsonSchema, subdata: unknown, path: string) => RecurseSchemaResult<unknown>): RecurseSchemaResult<T>;
         ...
         */
        function matchesSchemaType(value: any, schema: TcHmi.JsonSchema): boolean;
    }
}
declare namespace TcHmi {
    /**
...
declare namespace TcHmi {
    ...
    namespace ValueConverter {
         ...
         * @preserve (Part of the public API)
         */
        function toDimensionUnit(value: TcHmi.DimensionUnit | null): TcHmi.DimensionUnit | null;
        /**
         ...
         * @preserve (Part of the public API)
         */
        function toDimensionUnitEx(value: TcHmi.DimensionUnit | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toAngleUnit(value: TcHmi.AngleUnit | null): TcHmi.AngleUnit | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         ...
         * @preserve (Part of the public API)
         */
        function toAngleUnitEx(value: TcHmi.AngleUnit | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toBorderStyleValue(value: TcHmi.BorderStyleValue | null): TcHmi.BorderStyleValue | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toBorderStyleValue(value: TcHmi.BorderStyleValue | null, defaultValue: TcHmi.BorderStyleValue): TcHmi.BorderStyleValue;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toBorderStyleValueEx(value: TcHmi.BorderStyleValue | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toFontStyle(value: TcHmi.FontStyle | null): TcHmi.FontStyle | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toFontStyle(value: TcHmi.FontStyle | null, defaultValue: TcHmi.FontStyle): TcHmi.FontStyle;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toFontStyleEx(value: TcHmi.FontStyle | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toFontSizeUnit(value: TcHmi.FontSizeUnit | null): TcHmi.FontSizeUnit | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toFontSizeUnit(value: TcHmi.FontSizeUnit | null, defaultValue: TcHmi.FontSizeUnit): TcHmi.FontSizeUnit;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toFontSizeUnitEx(value: TcHmi.FontSizeUnit | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toFontWeight(value: TcHmi.FontWeight | null): TcHmi.FontWeight | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toFontWeight(value: TcHmi.FontWeight | null, defaultValue: TcHmi.FontWeight): TcHmi.FontWeight;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toFontWeightEx(value: TcHmi.FontWeight | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toHorizontalAlignment(value: TcHmi.HorizontalAlignment | null): TcHmi.HorizontalAlignment | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toHorizontalAlignment(value: TcHmi.HorizontalAlignment | null, defaultValue: TcHmi.HorizontalAlignment): TcHmi.HorizontalAlignment;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toHorizontalAlignmentEx(value: TcHmi.HorizontalAlignment | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toScaleModeString(value: TcHmi.ScaleModeString | null): TcHmi.ScaleModeString | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toScaleModeString(value: TcHmi.ScaleModeString | null, defaultValue: TcHmi.ScaleModeString): TcHmi.ScaleModeString;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toScaleModeStringEx(value: TcHmi.ScaleModeString | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toSizeMode(value: TcHmi.SizeMode | null): TcHmi.SizeMode | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toSizeMode(value: TcHmi.SizeMode | null, defaultValue: TcHmi.SizeMode): TcHmi.SizeMode;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toSizeModeEx(value: TcHmi.SizeMode | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toSizeModeWithContent(value: TcHmi.SizeModeWithContent | null): TcHmi.SizeModeWithContent | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toSizeModeWithContent(value: TcHmi.SizeModeWithContent | null, defaultValue: TcHmi.SizeModeWithContent): TcHmi.SizeModeWithContent;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toSizeModeWithContentEx(value: TcHmi.SizeModeWithContent | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toVerticalAlignment(value: TcHmi.VerticalAlignment | null): TcHmi.VerticalAlignment | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toVerticalAlignment(value: TcHmi.VerticalAlignment | null, defaultValue: TcHmi.VerticalAlignment): TcHmi.VerticalAlignment;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toVerticalAlignmentEx(value: TcHmi.VerticalAlignment | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toVisibility(value: TcHmi.Visibility | null): TcHmi.Visibility | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toVisibility(value: TcHmi.Visibility | null, defaultValue: TcHmi.Visibility): TcHmi.Visibility;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toToggleState(value: TcHmi.ToggleState | null): TcHmi.ToggleState | null;
        /**
         * Converts a value to enum value and returns the string or the given default value if the type of value is not compatible to the enum.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toToggleState(value: TcHmi.ToggleState | null, defaultValue: TcHmi.ToggleState): TcHmi.ToggleState;
        /**
         * Converts a value to enum value and returns the string or null if the type of value is not compatible to the enum. Returns a result object for error detection.
         * @param value The value to convert.
         * @param options options. For exmaple the default value
         ...
         * @preserve (Part of the public API)
         */
        function toToggleStateEx(value: TcHmi.ToggleState | null, options?: {
            /** The fallback value (null if not given) */
         ...
         * @preserve (Part of the public API)
         */
        function toFontFamily(value: TcHmi.FontFamily | null | undefined): TcHmi.FontFamily | null;
        /**
         * Converts a value to fontFamily value and returns the string or null if the type of value is not compatible to {string}.
         * @param value The value to convert.
         * @param defaultValue Value which should be returned if value is not compatible with the enum (null if not given)
         * @preserve (Part of the public API)
         */
        function toFontFamily(value: TcHmi.FontFamily | null | undefined, defaultValue: TcHmi.FontFamily): TcHmi.FontFamily;
        /**
...
declare namespace TcHmi {
    ...
    namespace View {
         ...
         * @preserve (Part of the public API)
         */
        function setScaleMode(scaleMode: TcHmi.ScaleModeString): void;
        /**
         ...
         */
        function removeViewportElement(element: HTMLElement): TcHmi.IErrorDetails;
        /**
...
declare namespace TcHmi {
    namespace IFunction {
         ...
         */
        function isStaticValue(value: TcHmi.IFunction.Value): value is TcHmi.IFunction.StaticValue;
        /**
         * Function Parser  Type Guard which checks 'objectType' of Value
         * @param value object to test
         */
        function isSymbol(value: TcHmi.IFunction.Value): value is TcHmi.IFunction.Symbol;
        /**
         * Function Parser Type Guard which checks 'objectType' of Value
         * @param value object to test
         */
        function isEventDataObject(value: TcHmi.IFunction.Value): value is TcHmi.IFunction.EventDataObject;
        /**
         * Function Parser  Type Guard which checks 'objectType' of Value
         * @param value object to test
         */
        function isFunctionExpression(value: TcHmi.IFunction.Value): value is TcHmi.IFunction.FunctionExpression;
    }
}
declare namespace TcHmi {
    namespace Trigger {
         ...
         */
        function isCondition(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.Condition;
        /**
         * Trigger Parser Type Guard which checks 'objectType' of Action
         * @param obj object to test
         */
        function isSwitchCase(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.SwitchCase;
        /**
         * Trigger Parser Type Guard which checks 'objectType' of Action
         * @param obj object to test
         */
        function isControlApiFunction(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.ControlApiFunction;
        /**
         * Trigger Parser Type Guard which checks 'objectType' of Action
         * @param obj object to test
         */
        function isWriteToSymbol(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.WriteToSymbol;
        /**
         * Trigger Parser Type Guard which checks 'objectType' of Action
         * @param obj object to test
         */
        function isComment(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.Comment;
        /**
         * Check if an object is a Function.
         * @param obj object to test
         */
        function isFunction(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.TAFunction;
        /**
         * Trigger Parser Type Guard which checks 'objectType' of Action
         * @param obj object to test
         */
        function isJavaScript(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.JavaScript;
        /**
         * Trigger Parser Type Guard which checks 'objectType' of Action
         * @param obj object to test
         */
        function isActionTemplate(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.ActionTemplate;
        /**
         * Check if an object is a FunctionExpression.
         * @param obj object to test
         */
        function isFunctionExpression(obj: TcHmi.Trigger.Action): obj is TcHmi.Trigger.FunctionExpression;
        /**
         * Check if an object is a ControlAttributeBindingTarget.
         * @param obj object to test
         */
        function isControlAttributeBindingTarget(obj: TcHmi.Trigger.BindingTarget): obj is TcHmi.Trigger.ControlAttributeBindingTarget;
    }
}
declare namespace TcHmi {
    /**
     ...
     */
    function isSolidColor(colorObject: TcHmi.Color | null | undefined): colorObject is TcHmi.SolidColor;
    /**
     * Checks if the parameter is a TcHmi.LinearGradientColor
     * @param colorObject The SolidColor to check.
     */
    function isLinearGradientColor(colorObject: TcHmi.Color | null | undefined): colorObject is TcHmi.LinearGradientColor;
    /**
     * Checks if the parameter is a TcHmi.Background
     * @param obj object to test
     * @preserve (Part of the public API)
     */
    function isBackground(obj: TcHmi.Background | null | undefined): obj is TcHmi.Background;
    /**
     * Checks if the parameter is a TcHmi.checkTransform
     * @param transformObject object to test
     * @preserve (Part of the public API)
     */
    function isTranslate(transformObject: TcHmi.Transform | null | undefined): transformObject is TcHmi.Translate;
    /**
     * Checks if the parameter is a TcHmi.Rotate
     * @param transformObject object to test
     * @preserve (Part of the public API)
     */
    function isRotate(transformObject: TcHmi.Transform | null): transformObject is TcHmi.Rotate;
    /**
     * Checks if the parameter is a TcHmi.Scale
     * @param transformObject object to test
     * @preserve (Part of the public API)
     */
    function isScale(transformObject: TcHmi.Transform | null): transformObject is TcHmi.Scale;
    /**
     * Checks if the parameter is a TcHmi.Skew
     * @param transformObject object to test
     * @preserve (Part of the public API)
     */
    function isSkew(transformObject: TcHmi.Transform | null): transformObject is TcHmi.Skew;
    /**
     * Checks if the parameter is a TcHmi.Origin
     * @param transformObject object to test
     * @preserve (Part of the public API)
     */
    function isOrigin(transformObject: TcHmi.Transform | null): transformObject is TcHmi.Origin;
    /**
     * Checks if the parameter is a TcHmi.Perspective
     * @param transformObject object to test
     * @preserve (Part of the public API)
     */
    function isPerspective(transformObject: TcHmi.Transform | null): transformObject is TcHmi.Perspective;
    /**
     * Check if an object is a Comparison.
     * @param value object to test
     */
    function isComparison(value: any): value is TcHmi.Comparison;
    /**
     * Check if an object is a Comparison
     * @param value object to test
     */
    function isLogicOperator(value: TcHmi.Comparison | TcHmi.LogicOperator | TcHmi.Filter): value is TcHmi.LogicOperator;
}
declare namespace TcHmi {
    /**
     * For internal use only.
...
declare namespace TcHmi.System {
    ...
    interface ControlAttributeList extends TcHmi.Dictionary<ControlAttribute> {
     ...
     */
    type IFunction = TcHmi.FunctionDefinition;
    /**
     * DEPRECATED
     * Please use FunctionArgument
     * @deprecated Please use FunctionArgument
     */
    type IFunctionArgument = TcHmi.FunctionArgument;
    interface FrameworkEventDescription extends TcHmi.baseEventDescription {
        /** category of this event */
        category: 'Framework';
    }
    interface ControlEventDescriptionWithInheritance extends TcHmi.ControlEventDescription {
        /** Inherited from (not implemented right now) */
        inheritControl?: string;
    }
    /**
...
declare namespace TcHmi.System {
     ...
     */
    function resolveControlHierarchy(ctrl: TcHmi.Controls.System.baseTcHmiControl, pctrl?: TcHmi.Controls.System.baseTcHmiControl | null): ControlHierarchy;
...
declare namespace TcHmi.System {
    ...
    const mapControlNamesFromPackageManifestApi0ToApi1: Map<string, string>;
...
declare namespace TcHmi.System {
    class InternalSymbolManager {
        ...
        watch<T = any>(name: string, callback: (this: void, data: TcHmi.System.InternalSymbolManager.IWatchResultObject<T>) => void): TcHmi.DestroyFunction;
    }
...
declare namespace TcHmi.System {
    class TimerSymbolManager {
         ...
         */
        watch<T = any>(name: string, callback: (this: void, data: TcHmi.System.TimerSymbolManager.IWatchResultObject<T>) => void): TcHmi.DestroyFunction;
        /**
...
declare namespace TcHmi.System {
    class Binding extends TcHmi.Destroyable {
         ...
         * @param callback
         */
        watchState(callback: (this: Binding, data: TcHmi.System.Binding.IWatchStateResultObject) => void): TcHmi.DestroyFunction;
    }
    namespace Binding {
        enum State {
            Invalid = 0,
...
declare namespace TcHmi.System {
    ...
    class BindingManager {
         ...
         * @param callback
         */
        watchPreloadingBindingDone(callback: (this: BindingManager, data: BindingManager.IWatchPreloadingBindingDoneResultObject) => void): TcHmi.DestroyFunction;
        /**
         * @param partialUrl
         * @param callback
         */
        watchPreloadingBindingDoneByPartial(partial: TcHmi.Controls.System.baseTcHmiControl, callback: (this: BindingManager, data: BindingManager.IWatchPreloadingBindingDoneResultObject) => void): TcHmi.DestroyFunction;
        /**
         * @param partialUrl
         * @param callback
         */
        watchPreloadingBindingDoneByControl(control: TcHmi.Controls.System.baseTcHmiControl, callback: (this: BindingManager, data: BindingManager.IWatchPreloadingBindingDoneResultObject) => void): TcHmi.DestroyFunction;
        /**
         * @param propertyName
         * @param fnThis
         */
...
declare namespace TcHmi.System {
    ...
    namespace ControlManager {
        interface CompileResult<C extends TcHmi.Controls.System.baseTcHmiControl> extends TcHmi.IResultObject {
            control?: C | undefined;
        }
 ...
 * @param s The eval expression (single expression text).
 * @param resSE This array will be used inside the evaluated expression.
 * @param resFCE This array will be used inside the evaluated expression.
 */
...
declare namespace TcHmi.System {
    class FunctionExpression extends TcHmi.Destroyable {
        ...
        constructor(functionExpression: string, options?: {
            ...
            forcedSymbolOptions?: Symbol.IOptions | null;
        });
        /**
         ...
         */
        execute(ctx: TcHmi.SelectableRequired<TcHmi.FunctionExpressionContext, 'success' | 'error'>, skipCallbackWithSyncValue: true): FunctionExpression.IFunctionResultHandled | FunctionExpression.IFunctionResultValue;
        /**
         * Sync and Async success and errors are always handled via CTX object.
         */
        execute(ctx: TcHmi.SelectableRequired<TcHmi.FunctionExpressionContext, 'success' | 'error'>): FunctionExpression.IFunctionResultHandled;
        watch(callback: (this: void, data: TcHmi.System.FunctionExpression.IWatchResultObject) => void): TcHmi.DestroyFunction;
        /**
...
declare namespace TcHmi.System {
    ...
    class ThemeManager {
         ...
         */
        watchThemedResource<T = any>(name: string, namespaceTokens: string[], callback: (this: void, data: TcHmi.System.ThemeManager.IWatchResultObject<T>) => void): TcHmi.DestroyFunction;
    }
...
declare namespace TcHmi.System {
    class ServerManager {
         ...
         */
        watch<T = any>(symbol: TcHmi.System.Symbol, expression: SymbolExpression, options: Symbol.IOptions | null, callback: (this: void, data: TcHmi.System.ServerManager.IServerWatchResultObject<T>) => void, reason?: string): TcHmi.DestroyFunction;
        /**
...
declare namespace TcHmi.System {
    class ServerEventManager {
         ...
         */
        confirmAlarm(alarm: Server.Events.RawServerAlarm, callback?: (this: void, data: TcHmi.IResultObject) => void): void;
        /**
    ...
    namespace ServerEventManager {
        ...
        interface ListResult extends TcHmi.IResultObject {
            events?: Server.Events.RawServerEvent[];
        }
        interface SubscriptionResult extends TcHmi.IResultObject {
            event?: Server.Events.RawServerEvent;
        }
        /**
         * Deprecated: Use public type from Server.Events instead
         * @deprecated Use public type from Server.Events instead
         */
        type RawServerEvent = Server.Events.RawServerEvent;
        /**
         * Deprecated: Use public type from Server.Events instead
         * @deprecated Use public type from Server.Events instead
         */
        type RawServerMessage = Server.Events.RawServerMessage;
        /**
         * Deprecated: Use public type from Server.Events instead
         * @deprecated Use public type from Server.Events instead
         */
        type RawServerAlarm = Server.Events.RawServerAlarm;
        /**
         * Deprecated: Use public type from Server.Events instead
         * @deprecated Use public type from Server.Events instead
         */
        type ServerAlarmChangeType = Server.Events.ServerAlarmChangeType;
    }
}
/**
 * Used to execute eval in isolated scope.
 * Allows user code to see globalThis, but not this module's local lexical bindings.
 * Only 'ctx' is provided intentionally.
 * @param ctx Context object
 * @param s The eval expression
 */
declare function gIsolatedEval_TcHmi_System_TriggerManager_JavaScriptAction(ctx: TcHmi.SelectableRequired<TcHmi.Context, 'success' | 'error' | 'args'>, s: string): void;
/**
 * Used to execute eval in isolated scope for condition expressions.
 * Provides only 'results' (array with compare values) to the expression string.
 * @param s Expression string that evaluates to a boolean.
 * @param results Pre-calculated compare results.
 */
...
declare namespace TcHmi.System {
    namespace Init {
        ...
        function run(initStep: INIT_STATE): void;
